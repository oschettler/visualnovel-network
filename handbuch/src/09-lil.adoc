...
Diese Sammlung stammt aus `zelda-network/game/README.md` (Abschnitt
"Sechs Lil-Fallstricke") und aus `plans/graphic-novel-plan.md`, Abschnitt
13. Beide gelten unverändert für dieses Projekt.
...
* `../zelda-network/game/README.md`, Abschnitt "Sechs Lil-Fallstricke",
  die Quelle der ersten sechs Punkte oben.
