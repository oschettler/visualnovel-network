...
Urmel-Bücher (Franz Josef Tripp), verbindlich beschrieben in
...
**Warum die Bildmitte frei bleibt:** die Puppen im Spiel sind transparente
Strichgrafik, der Hintergrund scheint also durch sie hindurch, sobald sie
nicht selbst eine deckende Fläche bekommen (dazu gleich mehr). Alles, was
in der Bildmitte liegt, erschiene sonst mitten im Gesicht der Figuren.
Deshalb stehen die Gegenstände in `szenen.py` konsequent am linken und
rechten Rand (`LINKS, RECHTS = 150, 874` bei 1024 Pixel Breite), und die
Mitte bleibt Papier. Das ist keine Notlösung, sondern genau der Aufbau der
Urmel-Vorlagen selbst.
...
Eine reine Strichzeichnung besteht nur aus Tusche und Transparenz. Ohne
Gegenmaßnahme scheint der Hintergrund mitten durch die Figur, das
Fensterkreuz landet im Auge, die Bodenschraffur quer über dem Mund. In den
Vorlagen ist die Figur dagegen weißes Papier und verdeckt, was hinter ihr
liegt.
...
[NOTE]
====
Ein erster Versuch hatte die Silhouette nachträglich aus dem fertigen Bild
gewonnen: die Tusche morphologisch schließen, von den Bildecken aus mit einer
Signalfarbe fluten, das Nichterreichte als Inneres nehmen. Das versiegelte
zwar den Kopf, nicht aber den Rumpf, denn der endet am unteren Bildrand und
ist dort offen, sodass die Flut von unten hereinlief. Auch ein größerer
Schließradius half nicht. Aus der Zeichnung heraus ist es sowohl einfacher
als auch vollständig: vier Bildbearbeitungsschritte sind zu zweien geworden,
und die Schultern decken jetzt ebenfalls.
====
